...
url = 'https://productionvn.akselos.com:9020/training_time_predict_projects/loi.nguyen/GE_Wind' \
      '/127PB_Phase_3_full_model_v2?view=jobs '
next_page_pattern = r'https://productionvn.akselos.com:9020/training_time_predict_projects/loi.nguyen/GE_Wind' \
                    r'/127PB_Phase_3_full_model_v2?view=jobs&job_id=&page_index= '
username = 'huandinh2022'
password = '27081996'
executable_path= "/bs_dir/chrome_sele/chromedriver_win32/chromedriver.exe"
...
total_page = int(driver.find_element(By.XPATH,'/html/body/div/div/div[2]/div[2]/div[2]/div/div/div[2]/div/div['
                                              '1]/span[1]').text[-2])
...
for i in range(total_page):
    crawl_page = next_page_pattern + str(i)
...
file_path = r'/huan_akselos/data/example_all_page.csv'
